...
void criogenizacion(vector<long long int> temperaturas, long long int &mayor, long long int &fMayor, long long int menor, long long int &fMenor) {
...
void resuelveCaso() {
	...
	long long int entrada, mayor, menor, fMayor, fMenor;
	cin >> entrada;
	while (entrada != 0) {
